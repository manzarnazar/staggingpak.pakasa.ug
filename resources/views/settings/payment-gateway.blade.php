                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <div class="form-group row mt-3">
                                ...
                                <div class="col-sm-12 mt-2">
                                    <input id="paystack_secret_key" name="gateway[PhonePe][secret_key]" type="text" class="form-control" placeholder="{{ __('PhonePe Merchent ID') }}" value="{{ $paymentGateway["PhonePe"]['secret_key'] ?? '' }}" >
                                </div>

                                <label for="paystack_publishable_key" class="col-sm-12 form-check-label  mt-2">{{ __('PhonePe Salt Key') }}</label>
                                <div class="col-sm-12 mt-2">
                                    <input id="paystack_publishable_key" name="gateway[PhonePe][api_key]" type="text" class="form-control" placeholder="{{ __('PhonePe Salt key') }}" value="{{ $paymentGateway["PhonePe"]['api_key'] ?? '' }}" >
                                </div>
